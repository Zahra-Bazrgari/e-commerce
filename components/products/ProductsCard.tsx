...
const ProductsCard = ({
  ...
  return (
    <div className="card-container bg-bs-white hover:shadow-2xl rounded-md text-bs-gray-dark p-4 grid grid-cols-1 gap-2 md:h-[450px]">
      <Link href={`/products/${_id}`} className="product-link">
